...
<<<<<<< HEAD
        ...
        <div>
            <table border="0" cellpadding="2" cellspacing="2" width="100%" style="background-color: transparent">
                <tr>
                    <td style="border-right: blue thin solid; border-top: blue thin solid; border-left: blue thin solid; border-bottom: blue thin solid; border-width: 0px"
                        align="center">
                        <table border="0" width="100%" style="background-color: transparent">
                                ...
                                <td id="Td1" align="center" runat="server" colspan="2">
                                    <div id="sse1">
                                        ...
                                        <asp:Label class="labelstyle" ID="lblName" runat="server" Font-Size="Large" ForeColor="White"
                                            Bold="true" Style="text-align: right; vertical-align: middle; font-family: 'Aclonica', serif; color: #fff; text-shadow: 0px 1px 0px #999, 0px 2px 0px #888, 0px 3px 0px #777, 0px 4px 0px #666, 0px 5px 0px #555, 0px 6px 0px #444, 0px 7px 0px #333, 0px 8px 7px #001135;" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <table>
                                        <tr>
                                            <td height="50%" style="font-weight: bold">Process Area: &nbsp;&nbsp;
                                            </td>
                                            <td>
                                                <div class="box">
                                            ...
                                            <td style="font-weight: bold">&nbsp;&nbsp; Equipment: &nbsp;&nbsp;
                                            </td>
                                            <td>
                                                <div class="box">
                                                    <telerik:RadComboBox ID="cboEquipment" runat="server" DropDownWidth="300px" OnSelectedIndexChanged="OnSelectedIndexChanged_cboEquipment"
                                                        ...
                                                        <HeaderTemplate>
                                                            <table style="width: 275px; font-size: small" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td style="width: 150px;">EquipID &nbsp;&nbsp;
                                                                    </td>
                                                                    <td style="width: 150px;">EquipType
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </HeaderTemplate>
                                                ...
                                                <div class="box">
                                                    <telerik:RadComboBox ID="cboComponent" runat="server" DropDownWidth="300px" Height="300px"
                                                        ...
                                                        <HeaderTemplate>
                                                            <table style="width: 275px; font-size: small" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td style="width: 150px;">CompNo &nbsp;&nbsp;
                                                                    </td>
                                                                    <td style="width: 150px;">CompName
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </HeaderTemplate>
...
<<<<<<< HEAD
                                    ...
                                    <ajaxToolkit:TabContainer runat="server" ID="tab_Thinning" Height="220px" ActiveTabIndex="0"
                                        ...
                                        <ajaxToolkit:TabPanel BackColor="#C0D7E8" runat="server" ID="TabPanel1" HeaderText="Thinning Damage Factor">
                                            <ContentTemplate>
                                                <div class="text" style="background: -webkit-linear-gradient(#e09432,#f8b117); height: 220px; overflow: auto;">
                                                    <br />
                                                    <br />
...
<<<<<<< HEAD
                                    ...
                                    <ajaxToolkit:TabContainer runat="server" ID="tab_Lining" Height="335px" ActiveTabIndex="0"
                                        ...
                                        <ajaxToolkit:TabPanel BackColor="#C0D7E8" runat="server" ID="TabPanel2" HeaderText="Component Lining Damage Factor">
                                            <ContentTemplate>
                                                <div class="text" style="background: -webkit-linear-gradient(#e09432,#f8b117); height: 335px; overflow: auto;">
                                                    <table width="60%" cellspacing="8">
                                                        <tr>
                                                            ...
                                                            <td align="right">
                                                                <asp:Button ID="btnLiningDelete" runat="server" Text=" Delete " OnClick="btnLiningDelete_Click"
                                                                    Font-Bold="true" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <ajaxToolkit:TabContainer runat="server" ID="tab_ExternalDamage" Height="400px" ActiveTabIndex="1"
                                        ...
                                        <ajaxToolkit:TabPanel BackColor="#C0D7E8" runat="server" ID="tab_ExternalDamage_tB"
                                            ...
                                            <ContentTemplate>
                                                <div class="text" style="background: -webkit-linear-gradient(#e09432,#f8b117); height: 400px; overflow: auto;">
                                                    <table width="60%" cellspacing="8">
                                                        <tr>
                                                            <td colspan="3">
...
<<<<<<< HEAD
                                    ...
                                    <ajaxToolkit:TabContainer runat="server" ID="tab_SCCDF" Height="340px" ActiveTabIndex="0"
                                        ...
                                        <ajaxToolkit:TabPanel BackColor="#C0D7E8" runat="server" ID="TabPanel3" HeaderText="Caustic">
                                            <ContentTemplate>
                                                <div class="text" style="background: -webkit-linear-gradient(#e09432,#f8b117); height: 340px; overflow: auto;">
                                                    <br />
                                                    <table width="60%" cellspacing="8">
                                                        <tr>
                                                            <td colspan="2">
...
<<<<<<< HEAD
                                                        ...
                                                        <tr>
                                                            <td colspan="2">is there is a known cracking:
                                                            <asp:CheckBox ID="chk_known_Crack" runat="server" AutoPostBack="True" OnCheckedChanged="chk_known_Crack_CheckedChanged" />
                                                            </td>
                                                            <td>Df-Scc:
                                                            </td>
...
<<<<<<< HEAD
                                    ...
                                    <ajaxToolkit:TabContainer runat="server" ID="tab_HTHA" Height="350px" ActiveTabIndex="0"
                                        ...
                                        <ajaxToolkit:TabPanel BackColor="#C0D7E8" runat="server" ID="TabPanel12" HeaderText="HTHA Damage Factor">
                                            <ContentTemplate>
                                                <div class="text" style="background: -webkit-linear-gradient(#e09432,#f8b117); height: 350px; overflow: auto;">
                                                    <table width="60%" cellspacing="8">
                                                        <tr>
                                                            <td colspan="4">
                                            ...
                                            <ContentTemplate>
                                                <div class="text" style="background: -webkit-linear-gradient(#e09432,#f8b117); height: 350px; overflow: auto;">
                                                    ...
                                                    <table width="90%" cellspacing="8">
                                                        ...
                                                        <tr>
                                                            <tr>
                                                                <td colspan="2">Number of previous failure have occured Dfb-PF:
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>Amount of Visible/Audible shaking Dfb-AS:
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">Amount of Visible/Audible shaking for year Ffb-AS:
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>Type of Cyclic loading connected Directly or Indirectly Dfb-CF:
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">Adjustment for Pipe complexity F-PC:
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>Adjustment for Condition of pipe F-CP:
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">Adjustment for joint type of Branch Design F-JB:
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>Adjustment for Branch Diameter F-BD:
                                                                </td>
                                                                <td>
                                    ...
                                    <ajaxToolkit:TabContainer runat="server" ID="tab_Brit_Fract" Height="360px" ActiveTabIndex="0"
                                        ...
                                        <ajaxToolkit:TabPanel BackColor="#C0D7E8" runat="server" ID="TabPanel13" HeaderText="Brittle Facture">
                                            <ContentTemplate>
                                                <div class="text" style="background: -webkit-linear-gradient(#e09432,#f8b117); height: 360px; overflow: auto;">
                                                    <br />
                                                    <table width="60%" cellspacing="8">
                                                        <tr>
                                                            <td colspan="4">
                                                        ...
                                                        <tr>
                                                            <td colspan="3">Process control exist is fully pressurized:
                                                            </td>
                                                            <td>
                                            ...
                                            <ContentTemplate>
                                                <div class="text" style="background: -webkit-linear-gradient(#e09432,#f8b117); height: 360px; overflow: auto;">
                                                    ...
                                                    <table width="60%" cellspacing="8">
                                                        ...
                                                        <tr>
                                                            <tr>
                                                                <td colspan="3">Did FATT Value is known:
                                                                </td>
                                                                <td>
                                                ...
                                                <div class="text" style="background: -webkit-linear-gradient(#e09432,#f8b117); height: 360px; overflow: auto;">
                                                    ...
                                                    <table width="60%" cellspacing="8">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3">Did Brittle Transition Temperature is known:
                                                            </td>
                                                            <td>
                                ...
                                <td align="center" style="width: 100%;">
                                    <div>
                                        <asp:SqlDataSource ID="SqlDataSourcePA" runat="server" ConnectionString="<%$ ConnectionStrings:connString %>"
                                            SelectCommand="SELECT [ProcessAreaID],[processarea] FROM [Tbl_ProcessArea] where deleted=0 ORDER BY [processareaid]"></asp:SqlDataSource>
                                    </div>
                                </td>
                            </tr>
                        </table>
