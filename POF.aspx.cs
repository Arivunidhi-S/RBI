...
<<<<<<< HEAD
    protected void btnLiningDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            //string strqrydup = "update COF_Flammable set Deleted=1 where ProcID='" + cboProcessArea.SelectedValue.ToString().Trim() + "' and  EquID='" + cboEquipment.SelectedValue.ToString().Trim() + "' and CompID ='" + cboComponent.SelectedValue.ToString().Trim() + "' and Deleted=0";
            string strqrydup = "delete from LiningDamage where ProcID='" + cboProcessArea.SelectedValue.ToString().Trim() + "' and  EquID='" + cboEquipment.SelectedValue.ToString().Trim() + "' and CompID ='" + cboComponent.SelectedValue.ToString().Trim() + "' and Deleted=0";
